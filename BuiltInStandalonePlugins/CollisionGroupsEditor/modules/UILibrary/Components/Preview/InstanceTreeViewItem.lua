--[[
	...
	Required Props:
		...
		Indentation = number, The level of indentation this item appears at.
		Expandable = boolean, Whether this item has children and can be expanded.
		Expanded = boolean, Whether this item is showing its children.
		Selected = boolean, Whether this item is the selected item.
		LayoutOrder = number, The order in which this item appears in the list.
		OnClick = callback, A callback when this item is clicked.
]]
