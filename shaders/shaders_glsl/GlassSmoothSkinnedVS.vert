...
void main()
{
    ...
    vec4 v26 = vec4(v23, v25.w);
    float v27 = COLOR0.w * 2.0;
    float v28 = clamp(v27 - 1.0, 0.0, 1.0);
    float v29 = clamp(v27, 0.0, 1.0);
    float v30 = (clamp(2.0 - (dot(v20, normalize(v26.xyz)) * 3.0), 0.0, 1.0) * 0.300000011920928955078125) * v29;
    vec4 v31 = COLOR0;
    v31.w = mix(v28, 1.0, v30);
    vec4 v32 = vec4(dot(CB0[20], v24), dot(CB0[21], v24), dot(CB0[22], v24), 0.0);
    v32.w = mix((COLOR1.w * 0.0039215688593685626983642578125) * v28, 1.0, v30);
    gl_Position = v25;
    VARYING0 = TEXCOORD0;
    VARYING1 = TEXCOORD1;
    VARYING2 = v31;
    ...
    VARYING6 = vec4((CB0[10].xyz * max(v22, 0.0)) + (CB0[12].xyz * max(-v22, 0.0)), (((float(v22 > 0.0) * pow(clamp(dot(v20, normalize(v21 + normalize(v23))), 0.0, 1.0), COLOR1.z)) * v29) * (COLOR1.y * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = v32;
    VARYING8 = NORMAL.w;
}
