...
void main()
{
    ...
    VARYING5 = vec4((CB0[10].xyz * max(v19, 0.0)) + (CB0[12].xyz * max(-v19, 0.0)), ((float(v19 > 0.0) * pow(clamp(dot(v17, normalize(v18 + normalize(v20))), 0.0, 1.0), COLOR1.z)) * (COLOR1.y * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING6 = vec4(dot(CB0[20], v21), dot(CB0[21], v21), dot(CB0[22], v21), 0.0);
    VARYING7 = NORMAL.w;
}
