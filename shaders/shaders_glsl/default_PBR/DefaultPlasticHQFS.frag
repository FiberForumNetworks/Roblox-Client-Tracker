...
void main()
{
    ...
    vec3 f7 = normalize(((VARYING6.xyz * f6.x) + ((cross(VARYING5.xyz, VARYING6.xyz) * VARYING6.w) * f6.y)) + (VARYING5.xyz * f5));
    ...
    vec3 f18 = textureCube(EnvironmentMapTexture, reflect(-f16, f7)).xyz;
    vec3 f19 = -CB0[11].xyz;
    ...
    gl_FragData[0] = vec4(f36.x, f36.y, f36.z, f33.w);
}
