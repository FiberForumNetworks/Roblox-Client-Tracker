...
void main()
{
    ...
    float v23 = v22.w;
    vec4 v24 = ((exp2(TEXCOORD3 * 0.0625) - vec4(1.0)) * CB0[23].z) + vec4((0.5 * v23) * CB0[23].y);
    vec4 v25 = vec4(v13, v14, v15, 0.0);
    v25.w = COLOR1.w * 0.0039215688593685626983642578125;
    gl_Position = v22;
    VARYING0 = vec4(TEXCOORD0.x, TEXCOORD0.y, v24.x, v24.y);
    VARYING1 = vec4(TEXCOORD1.x, TEXCOORD1.y, v24.z, v24.w);
    VARYING2 = COLOR0;
    VARYING3 = ((v16 + (v20 * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    VARYING4 = vec4(CB0[7].xyz - v16, v23);
