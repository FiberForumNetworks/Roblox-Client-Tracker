...
void main()
{
    ...
    float v21 = dot(v20, -CB0[11].xyz);
    vec4 v22 = vec4(v13, v14, v15, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec4 v23 = vec4(TEXCOORD1.x, TEXCOORD1.y, vec4(0.0).z, vec4(0.0).w);
    v23.x = max(0.0500000007450580596923828125, TEXCOORD1.x);
    float v24 = v22.w;
    vec4 v25 = ((exp2(TEXCOORD3 * 0.0625) - vec4(1.0)) * CB0[23].z) + vec4((0.5 * v24) * CB0[23].y);
    vec4 v26 = vec4(v13, v14, v15, 0.0);
    v26.w = COLOR1.w * 0.0039215688593685626983642578125;
    gl_Position = v22;
    VARYING0 = vec4(TEXCOORD0.x, TEXCOORD0.y, v25.x, v25.y);
    VARYING1 = vec4(v23.x, v23.y, v25.z, v25.w);
    VARYING2 = COLOR0;
    VARYING3 = ((v16 + (v20 * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    VARYING4 = vec4(CB0[7].xyz - v16, v24);
    VARYING5 = vec4(v17, v18, v19, COLOR1.z);
    VARYING6 = vec4((CB0[10].xyz * max(v21, 0.0)) + (CB0[12].xyz * max(-v21, 0.0)), (float(v21 > 0.0) * (COLOR1.y * 0.0039215688593685626983642578125)) * CB0[23].w);
    VARYING7 = v26;
    VARYING8 = NORMAL.w;
}
