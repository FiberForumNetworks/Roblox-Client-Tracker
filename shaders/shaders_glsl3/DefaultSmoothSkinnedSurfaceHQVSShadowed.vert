...
void main()
{
    ...
    vec4 v26 = vec4(v14, v15, v16, 1.0) * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    float v27 = v26.w;
    vec4 v28 = ((exp2(TEXCOORD3 * 0.0625) - vec4(1.0)) * CB0[23].z) + vec4((0.5 * v27) * CB0[23].y);
    vec4 v29 = vec4(v14, v15, v16, 0.0);
    v29.w = COLOR1.w * 0.0039215688593685626983642578125;
    gl_Position = v26;
    VARYING0 = vec4(TEXCOORD0.x, TEXCOORD0.y, v28.x, v28.y);
    VARYING1 = vec4(TEXCOORD1.x, TEXCOORD1.y, v28.z, v28.w);
    VARYING2 = COLOR0;
    VARYING3 = ((v17 + (vec3(v19, v21, v23) * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    VARYING4 = vec4(CB0[7].xyz - v17, v27);
    VARYING5 = vec4(v19, v21, v23, COLOR1.z);
