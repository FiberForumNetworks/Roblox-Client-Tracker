...
void main()
{
    ...
    vec4 v24 = vec4(TEXCOORD1.x, TEXCOORD1.y, vec4(0.0).z, vec4(0.0).w);
    v24.x = max(0.0500000007450580596923828125, TEXCOORD1.x);
    float v25 = v23.w;
    vec4 v26 = ((exp2(TEXCOORD3 * 0.0625) - vec4(1.0)) * CB0[23].z) + vec4((0.5 * v25) * CB0[23].y);
    vec4 v27 = vec4(dot(CB0[20], v22), dot(CB0[21], v22), dot(CB0[22], v22), 0.0);
    v27.w = COLOR1.w * 0.0039215688593685626983642578125;
    gl_Position = v23;
    VARYING0 = vec4(TEXCOORD0.x, TEXCOORD0.y, v26.x, v26.y);
    VARYING1 = vec4(v24.x, v24.y, v26.z, v26.w);
    VARYING2 = COLOR0;
    VARYING3 = ((v16 + (v20 * 6.0)).yxz * CB0[16].xyz) + CB0[17].xyz;
    VARYING4 = vec4(CB0[7].xyz - v16, v25);
