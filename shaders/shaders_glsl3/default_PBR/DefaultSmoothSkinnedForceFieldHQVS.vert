...
void main()
{
    ...
    vec4 v20 = vec4(v13, v14, v15, 1.0);
    vec4 v21 = v20 * mat4(CB0[0], CB0[1], CB0[2], CB0[3]);
    vec4 v22 = vec4(TEXCOORD1.x, TEXCOORD1.y, vec4(0.0).z, vec4(0.0).w);
    v22.x = max(0.0500000007450580596923828125, TEXCOORD1.x);
    float v23 = v21.w;
    vec4 v24 = ((exp2(TEXCOORD3 * 0.0625) - vec4(1.0)) * CB0[23].z) + vec4((0.5 * v23) * CB0[23].y);
    vec4 v25 = vec4(dot(CB0[20], v20), dot(CB0[21], v20), dot(CB0[22], v20), 0.0);
    v25.w = COLOR1.z * 0.0039215688593685626983642578125;
    vec4 v26 = vec4(v17, v18, v19, COLOR1.z);
